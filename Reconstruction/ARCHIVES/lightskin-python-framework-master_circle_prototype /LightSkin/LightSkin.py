...
class LightSkin:
    ...
    def getGridArea(self) -> ValueGridAreaDefinition:
        ...
        min_x, min_y, max_x, max_y = self._findMinMaxPos() # finds the min_x max_x min_y max_y values
        # returns obj of type ValueGridAreaDefinition with the attributes min_x, max_x, min_y, max_y, width_x, width_y
